...
mkdir test_mongo
sudo docker run -d --name mongodb -p 27017:27017 -v /home/student/test_mongo:/data/db -e ME_CONFIG_MONGODB_ADMINUSERNAME=admin -e ME_CONFIG_MONGODB_ADMINPASSWORD=password mongo
